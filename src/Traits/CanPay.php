...
trait CanPay
{
    ...
    {
        return current($this->payFreeCart(make(Cart::class)->addItem($product)));
    }
    ...
    {
        return current($this->safePayCart(make(Cart::class)->addItem($product), $force)) ?: null;
    }
    ...
    {
        return current($this->payCart(make(Cart::class)->addItem($product), $force));
    }
    ...
    {
        return current($this->forcePayCart(make(Cart::class)->addItem($product)));
    }
    ...
    {
        return $this->safeRefundCart(make(Cart::class)->addItem($product), $force, $gifts);
    }
    ...
    {
        return $this->refundCart(make(Cart::class)->addItem($product), $force, $gifts);
    }
    ...
    {
        return $this->forceRefundCart(make(Cart::class)->addItem($product), $gifts);
    }
    ...
    {
        return $this->safeRefundGiftCart(make(Cart::class)->addItem($product), $force);
    }
    ...
    {
        return $this->refundGiftCart(make(Cart::class)->addItem($product), $force);
    }
    ...
    {
        return $this->forceRefundGiftCart(make(Cart::class)->addItem($product));
    }
}
